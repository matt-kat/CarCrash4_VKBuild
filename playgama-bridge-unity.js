...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/CarCrash4_VKBuild.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/CarCrash4_VKBuild.data.unityweb',
                        frameworkUrl: 'Build/CarCrash4_VKBuild.framework.js.unityweb',
                        codeUrl: 'Build/CarCrash4_VKBuild.wasm.unityweb',
